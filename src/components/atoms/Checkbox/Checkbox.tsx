...
const Icon = styled.svg`
    fill: none;
    height: 15px;
    stroke: ${({ theme }) => theme.colors.light.brandAccent};
    stroke-width: 2px;
    width: 15px;
`;
...
const StyledCheckbox = styled.div<{ checked: boolean; hasError: boolean }>`
    ...
    border: 1.5px solid
        ${({ theme, checked }) =>
            checked ? theme.colors.light.brandAccent : theme.colors.light.mediumGrey};
    border-radius: 2px;
    ...
    &:hover {
        border: 1.5px solid ${({ theme }) => theme.colors.light.brandAccent};
    }
