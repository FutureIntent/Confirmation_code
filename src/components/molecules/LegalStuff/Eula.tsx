...
import HtmlWithText from "@components/molecules/LegalStuff/Eula/HtmlWithText";
    ...
    return (
        <GridParent>
            <GridChild gridColumn={{ _: 'span 12', laptopS: '4/ span 6' }}>
                <Typography variant="h1" color={{ light: 'light.brandBlack', dark: 'dark.white'}} mb={15} textAlign="center">{t('eula')}</Typography>
                <Wrapper>
                    <HtmlWithText />
                </Wrapper>
            </GridChild>
